        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-3">
            ...
            <p className="text-sm text-muted-foreground max-w-xs">
              The premier marketplace for renting event and entertainment equipment.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/cancellation" className="text-muted-foreground hover:text-foreground transition-colors">
